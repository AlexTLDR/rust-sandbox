// use exercise::sound;
// use exercise::{FIRST, SECOND, THIRD};
use exercise::prelude::*;
...
// - Move all the constants into lib.rs
...
// Challenge 2
//
// Create an `animal::prelude` module which re-exports all the constants and functions of the
